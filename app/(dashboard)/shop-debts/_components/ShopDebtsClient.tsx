...
import { Store, Plus, Check, Trash2, ShieldAlert } from "lucide-react";
...
export function ShopDebtsClient() {
  ...
  const handlePayConfirm = () => {
    if (payConfirmId) {
      payMutation.mutate(payConfirmId);
    ...
    return (
      <div className="min-h-[50vh] flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-sm text-slate-500 mt-2">Only managers and admins can view shop debts.</p>
        </div>
      </div>
    );
  }
    ...
    <div className="space-y-8">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <button
          ...
          className="flex items-center gap-2 px-4 py-2.5 bg-primary-600 hover:bg-primary-700 text-white rounded-xl text-sm font-semibold shadow-sm hover:shadow transition cursor-pointer self-start sm:self-auto"
        >
      ...
      <ConfirmModal
        ...
        title="Clear Shop Due"
        message="Are you sure you want to mark this shop debt as PAID?"
      ...
      <ConfirmModal
        ...
        title="Delete Debt Log"
        message="Are you sure you want to delete this debt log? This cannot be undone."
        confirmText="Delete"
        cancelText="Cancel"
        variant="danger"
