...
import { X, ShoppingBag, Save, Plus, Trash2, Upload, Image as ImageIcon, Camera } from "lucide-react";
...
export function MarketingEditModal({ isOpen, onClose, data, onSuccess }: MarketingEditModalProps) {
    ...
    useEffect(() => {
        if (data) {
            ...
            const allSingleItems = data.items?.every((item: any) =>
                item.quantity === 1 && item.unit === "PIECE"
            );
            ...
            setFormData({
                ...
                items: data.items?.map((item: any) => ({
                    ...
                    note: item.note || "",
                })) || [{ itemName: "", quantity: 1, unit: "PIECE", price: 0, totalPrice: 0, note: "" }],
            });
        }
    }, [data]);
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        console.log("📝 [EDIT] Form data before validation:", formData);
        ...
        console.log("📝 [EDIT] Items array:", itemsArray);
        console.log("📝 [EDIT] Items JSON:", JSON.stringify(itemsArray));
        ...
        if (selectedImage) {
            ...
            console.log("📝 [EDIT] Image selected:", selectedImage.name, selectedImage.size);
        }

        console.log("📝 [EDIT] Final payload:", payload);
        console.log("📝 [EDIT] Payload JSON:", JSON.stringify(payload));
        ...
        updateMarketing.mutate(
            ...
            },
            {
                ...
                onError: (error: any) => {
                    ...
                    console.error("❌ [EDIT] Error data:", error.response?.data);
                    const message = error.response?.data?.message || "Failed to update bazar entry";
                    toast.error(message);
                    setIsSubmitting(false);
                },
            }
                                            ...
                                            <div className="flex items-center gap-3">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-xs text-slate-400">
                                                        {isImageMode ? 'Only Name & Price needed' : 'JPEG, PNG, GIF, WEBP (Max 10MB)'}
                                                    </p>
                                                </div>
                                            </div>
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                        <div>
                                            ...
                                            <input
                                                ...
                                                disabled
                                            />
                                            <p className="text-[10px] text-slate-400 mt-1">Date cannot be changed</p>
                                        </div>
